...
Operational and runtime details for local development and troubleshooting.
...
Most behavior issues are in runtime files under `~/.config`, not only this repo.
...
## Implementation Notes That Commonly Matter
